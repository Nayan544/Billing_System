...
from .views import create_invoice, invoice_detail, InvoiceListView, edit_invoice, invoiceDeleteView, invoice_pdf_view, add_payment, add_invoice_item
...
urlpatterns = [
    ...
    path('add-item/<int:pk>/', add_invoice_item, name='invoice-add-item'),
]